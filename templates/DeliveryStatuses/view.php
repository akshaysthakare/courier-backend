      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= h($deliveryStatus->name) ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($deliveryStatus->id) ?></dd>
            <dt scope="row"><?= __('Created') ?></dt>
            <dd><?= h($deliveryStatus->created) ?></dd>
            <dt scope="row"><?= __('Modified') ?></dt>
            <dd><?= h($deliveryStatus->modified) ?></dd>
          </dl>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($deliveryStatus->bookings)): ?>
          <table class="table table-hover">
              ...
              <?php foreach ($deliveryStatus->bookings as $bookings): ?>
              <tr>
                    <td><?= h($bookings->id) ?></td>
